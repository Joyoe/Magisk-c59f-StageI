...
void jokerhide_handler(int client, ucred *cred) {
...
int jokerhide_main(int argc, char *argv[]) {
    ...
    case HIDE_NOT_ENABLED:
        fprintf(stderr, "JokerHide is not enabled\n");
        goto return_code;
    case HIDE_IS_ENABLED:
        fprintf(stderr, "JokerHide is enabled\n");
        goto return_code;
